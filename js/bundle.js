...
function forms(formSelector, modalSelector, modalTimer, messageSelector) {
  ...
  function showThanksModal(message) {
    var prevModaldialog = document.querySelector(messageSelector);
    (0,_modal__WEBPACK_IMPORTED_MODULE_10__.openModal)(modalSelector, modalTimer);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_10__.closeModal)(modalSelector);
    }, 4000);
  }
}
...
function slider(_ref) {
  var sliderSelector = _ref.sliderSelector,
      ...
      currentSelector = _ref.currentSelector,
      wrapperSelector = _ref.wrapperSelector,
      innerSelector = _ref.innerSelector;
  ...
  dots.forEach(function (item) {
    item.addEventListener('click', function (event) {
      var attribute = event.target.getAttribute('data-slide-to');
      index = attribute;
  ...
  function totalNumber(slides) {
    if (slides.length < 10) {
      total.innerHTML = "0".concat(slides.length);
    } else {
  ...
  function currentNumber(index) {
    if (index < 10) {
      current.innerHTML = "0".concat(index);
    } else {
...
document.addEventListener('DOMContentLoaded', function () {
  var modalTimer = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('[data-modal]', modalTimer);
  }, 5000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-05-20');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.default)('[data-open]', 'data-close', '[data-modal]', modalTimer);
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__.default)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)('form', '[data-modal]', modalTimer, '.modal__dialog');
